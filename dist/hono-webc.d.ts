...
declare module 'hono' {
    interface ContextRenderer {
        (content: string | Promise<string>, data?: Record<string | number | symbol, unknown>): Response | Promise<Response>;
    }
}
type HonoWebcOptions = {
    /**
...
declare const honoWebc: (options?: HonoWebcOptions) => hono.MiddlewareHandler<any, any, {}>;
