import { parse5 as _parse5, WebC as _WebC } from 'jsr:@esroyo/webc-lax@1.0.2';
...
export type { Env as HonoEnv, Input as HonoInput, MiddlewareHandler as HonoMiddlewareHandler } from 'jsr:@hono/hono@4.4.4/types';
